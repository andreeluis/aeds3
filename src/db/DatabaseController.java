...
public class DatabaseController<T extends Register> {
  ...
  public DatabaseController(String filePath, Constructor<T> constructor) throws FileNotFoundException {
  ...
  public boolean sort(int pathsNumber, int inMemoryRegisters) {
    ...
    //index.rebuild(this.database.getFile());
